...
REM Requires: tidy                                                             #
REM                                                                            #
REM Returns:  Creates out.html file in current directory if -write, otherwise  #
REM             null                                                           #
REM                                                                            #
REM ############################################################################
...
rem tidyargs is either "-e" or "-o out.html -i -wrap 123 -c -b -q",
rem and in both cases we append encoding
