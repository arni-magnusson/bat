...
REM                                                                                                                    #
REM Notes:    Suggested -size values: 800  640  400  320  280  240  200  160  120  100  80  60                         #
REM                                   600  480  300  240  210  180  150  120   90   75  60  45                         #
REM                                                                                                                    #
REM Requires: convert                                                                                                  #
REM                                                                                                                    #
REM Returns:  Creates image file with same name and thumb_ prefix in current directory                                 #
REM                                                                                                                    #
REM ####################################################################################################################
...
echo 1600  1440  1200  1000  800  640  480  400  320  240  200  160  120  100  80  60
echo 1200  1080   900   750  600  480  360  300  240  180  150  120   90   75  60  45
echo.
