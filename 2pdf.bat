...
REM                                                                                                                    #
REM Purpose:  Convert bitmap, TEX, DTX, TEXI, DVI, PS, EPS, or PDF file to PDF format                                  #
REM                                                                                                                    #
REM Args:     flate selects Flate compression, to prevent JPEG artifacts on embedded bitmaps                           #
REM           gray creates grayscale PDF                                                                               #
REM           paper selects PDF page size, a4 or letter when converting DVI or PS file                                 #
REM           quality determines image quality (screen, ebook, printer, prepress, default)                             #
REM           file is file to convert                                                                                  #
REM                                                                                                                    #
REM Requires: bmeps, convert, dvipdfm, gswin32c, texi2dvi, texify                                                      #
REM                                                                                                                    #
REM Warning:  -paper is often ignored by dvips, must edit manually in PS file (change line following %%BeginPaperSize) #
REM                                                                                                                    #
REM Returns:  Creates PDF file with same prefix in current directory, or filename_.pdf if input file was PDF           #
REM                                                                                                                    #
REM ####################################################################################################################
