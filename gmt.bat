...
echo pscoast -JM18c -R27W/11W/62N/68N -Di -G100/200/100 -B4f2g2/2f1g1^
    -K ^>  map.ps
echo psxy demo.xy -JM -R -Scp -W2p                                   ^
 -O -K ^>^> map.ps
echo pstext demo.txt -JM -R                                          ^
 -O -K ^>^> map.ps
echo psxy demo.bar -JM -R -W1p -G180 -A -m                           ^
 -O    ^>^> map.ps
