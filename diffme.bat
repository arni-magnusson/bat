...
REM                                                                            #
REM Args:     left shows entire file1 in left column, and only file2 diffs in  #
REM             right column                                                   #
REM           suppress shows only diffs in each columns                        #
REM           W is width of each column                                        #
REM           file1 and file2 are files to compare                             #
REM                                                                            #
REM Notes:    Thin wrapper to remind user about three helpful options for      #
REM             2-column display                                               #
REM                                                                            #
REM Requires: diff                                                             #
REM                                                                            #
