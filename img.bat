...
REM                                                                                                                    #
REM Notes:    Multipage files have page-specific attributes shown in a very long line, consider 'identify' for those   #
REM           PDF and EPS files are analyzed as if they had been converted to TIF (many bytes etc.)                    #
REM                                                                                                                    #
