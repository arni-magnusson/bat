...
REM                                                                                                                    #
REM Args:     glob is the filename pattern to look for (case-insensitive, possibly containing *)                       #
REM                                                                                                                    #
REM Requires: find                                                                                                     #
REM                                                                                                                    #
...
rem Old "unxutils" version 4.1 can search in ~/emacs/backup, but "gnuwin32" or "rtools" can't
