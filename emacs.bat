...
REM                                                                                                                    #
REM Notes:    Used in the command line, so emacs.bat needs to be before emacs.exe in the path                          #
REM           Luckily, R options(editor="emacs") runs emacs.exe, not emacs.bat, so fix(function) updates code          #
REM                                                                                                                    #
